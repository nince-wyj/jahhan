...
public class Redis implements DBCache {
	...
	public Long del(final String... keys) {
		if (RedisConstants.isInUse()) {
			getTemplate().execute(new JedisCallBackHandler<Long>() {
	...
	public boolean exists(final String key) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<Boolean>() {
	...
	public void expire(final String cachedKey, final int seconds) {
		if (RedisConstants.isInUse()) {
			getTemplate().execute(new JedisCallBackHandler<Void>() {
	...
	public Set<String> keys(final String match) {
		if (RedisConstants.isInUse()) {
			...
			return getTemplate().execute(new JedisCallBackHandler<Set<String>>() {
	...
	public long decr(final String key) {
		if (RedisConstants.isInUse()) {
			Long v = getTemplate().execute(new JedisCallBackHandler<Long>() {
				public Long invoke(Jedis jedis) {
	...
	public byte[] getBinary(final byte[] key) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<byte[]>() {
	...
	public String get(final String key) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<String>() {
	...
	public List<String> mget(final String[] keys) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<List<String>>() {
	...
	public List<byte[]> mgetByte(final byte[][] keys) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<List<byte[]>>() {
	...
	public Map<String, String> hgetAll(final String key) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<Map<String, String>>() {
	...
	public boolean removeLeft(final String key, final int count) {
		if (RedisConstants.isInUse()) {
			String ret = getTemplate().execute(new JedisCallBackHandler<String>() {
				public String invoke(Jedis jedis) {
	...
	public Object evalsha(final String sha1, final int keyCount, final String... params) {
		if (RedisConstants.isInUse()) {
			return getTemplate().execute(new JedisCallBackHandler<Object>() {
