...
public @interface Cache {
    ...
    /**
     * 该字段配合字段argumentIndexNumbers使用，但配置了argumentIndexNumbers不一定要配置该字段，配置了则长度length要相等
     * 当参数是对象时，用来指定获取参数对象的字段值当成key，指定多个字段时，用英文逗号“,”隔开；
     * 对于没有字段的参数对象，可以用空串代替""，如Long、String，Float等等
     *
     */
    public String[] indexArgumentField() default {};
