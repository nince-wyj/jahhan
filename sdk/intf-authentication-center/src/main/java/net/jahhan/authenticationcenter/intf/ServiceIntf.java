...
import net.jahhan.authenticationcenter.vo.ServiceAuthenticationOVO;
import net.jahhan.authenticationcenter.vo.ServiceAuthorizeMessageOVO;
import net.jahhan.authenticationcenter.vo.ServiceLoginIVO;
import net.jahhan.authenticationcenter.vo.ServiceLoginOVO;
import net.jahhan.authenticationcenter.vo.ServiceRegisteIVO;
import net.jahhan.authenticationcenter.vo.ServiceRegisteOVO;
