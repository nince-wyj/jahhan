...
public final class IterableUtils {
	 ...
	 *            to look for.
	 * @param <T>
	 *            type of the objects stored in the iterable.
	 ...
	 *            exception message if there are no elements.
	 * @param <T>
	 *            type of the element.
	 ...
	 *             in case the iterable contains more than 1 element.
	 */
	public static <T> T getSingle(Iterator<T> iterator, String notFoundMessage) {
		T result = getSingleOrNull(iterator);
		Assert.notNull(result, notFoundMessage, SystemErrorCode.UNKOWN_ERROR);
