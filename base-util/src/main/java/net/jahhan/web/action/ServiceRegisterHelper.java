...
//						BaseContext.CTX.getFieldManager().setFieldClass(actionService.act(), fieldName,
//								field.referenceObject());
//					}
//				}
//
//				BaseContext.CTX.getFieldManager().registerImportMap(actionService.act(), importMap);
//				BaseContext.CTX.getFieldManager().register(actionService.act(), fieldMap);
