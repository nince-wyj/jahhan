 ...
 * @author nince
 */
public class BigDecimalFieldTypeHandler implements FieldTypeHandler {

	private final Logger logger = LoggerFactory.getInstance().getLogger(BigDecimalFieldTypeHandler.class);
	...
	public boolean validate(Map<String, Object> requestMap, String fieldName, Object value, String version) {
		...
		if (value != null) {
			try {
				BigDecimal parseValue = BigDecimal.valueOf(Double.parseDouble(String.valueOf(value)));
				isValidate = true;
