...
import net.jahhan.spi.Exchanger;
...
public class ProtocolConfig extends AbstractConfig {
	...
	public static void destroyAll() {
		...
		for (String protocolName : ExtensionExtendUtil.getSupportedExtensions(Protocol.class)) {
			try {
				Protocol protocol = ExtensionExtendUtil.getExtension(Protocol.class, protocolName);
				if (protocol != null) {
					protocol.destroy();
				}
			} catch (Throwable t) {
