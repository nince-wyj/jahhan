        ...
        if (e instanceof HessianConnectionException) {
            if (e.getCause() != null) {
                ...
                if (SocketTimeoutException.class.equals(cls)) {
                    return JahhanErrorCode.TIMEOUT_EXCEPTION;
                }
            }
            return JahhanErrorCode.NETWORK_EXCEPTION;
        } else if (e instanceof HessianMethodSerializationException) {
            return JahhanErrorCode.SERIALIZATION_EXCEPTION;
        }
            ...
            if (server != null) {
                try {
                    if (log.isInfoEnabled()) {
                        log.info("Close hessian server " + server.getUrl());
                    }
                    server.close();
                } catch (Throwable t) {
